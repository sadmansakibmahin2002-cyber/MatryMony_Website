...
$sql = "SELECT id, full_name, email, profile_id, status FROM users ORDER BY id DESC";
...
<a href="alluser.php" class="active">All Users</a>
...
<tr>
<th>#</th><th>Profile ID</th><th>Name</th><th>Email</th><th>Status</th><th>Action</th>
</tr>
</thead>
<tbody>
